...
x_input = np.random.randn(1, 572, 572, 1) 
out_ch = 64
pool_s, skip_s = unet_encoder_block(x_input, out_channels=out_ch)

print(f"Skip Connection Shape: {skip_s}") 
print(f"Next Layer Input Shape: {pool_s}") 